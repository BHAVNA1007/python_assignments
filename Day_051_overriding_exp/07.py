...
class Pizza:
    def __init__(self, base_price, topping_cost, quantity):
    ...
    def calculatePrice(self):
        ...
        self.price =  self.base_price +(self.topping_cost * self.quantity)
        print(f"Price without discount: Rs. {self.price:.2f}")
...
class DiscountedPizza(Pizza):
    ...
    def calculatePrice(self): 
        ...
        print(f"price with discount: {self.price:.2f}")         
 
base_price = float(input("Base price: " ))
topping_cost = float(input("topping cost: "))
quantity = int(input("quantity: "))

if base_price > 0 and topping_cost > 0 and 1<= quantity <= 10:

     pizza = Pizza(base_price, topping_cost, quantity)
     pizza.calculatePrice()

     discount = DiscountedPizza(base_price, topping_cost, quantity)
